...
describe("VeYieldDistributorProxy", function() {
  ...
  describe("NotifyRewardProxy", function () {
    it("Should transfer reward amount to VeUnoDaoYieldDistributor", async function () {
      ...
      // Should revert when caller has no executor role
      ...
      // // Should revert when notifyRewardProxy is not whitelisted in veUnoDaoYieldDistributor
      ...
      console.log("balance before ==>", balaceBefore.toString());
