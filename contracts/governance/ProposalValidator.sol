...
contract ProposalValidator is IProposalValidator {
    ...
    function getMinimumPropositionPowerNeeded(
        ...
        return
            (currentGovernanceStrategy.getTotalPropositionSupplyAt(
                blockNumber
    ...
    function isVoteDifferentialValid(
        ...
        return (((proposal.forVotes * ONE_HUNDRED_WITH_PRECISION) /
            votingSupply) >
            ((proposal.againstVotes * ONE_HUNDRED_WITH_PRECISION) /
                votingSupply) +
                (VOTE_DIFFERENTIAL));
    }
}
